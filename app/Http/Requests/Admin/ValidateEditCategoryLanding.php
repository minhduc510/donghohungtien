...
class ValidateEditCategoryLanding extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return     [
            ...
            "icon.mimes" => "icon category in jpeg,jpg,png,svg,webp,gif",
            "icon_path.max" => "icon category size < 3mb",
            "avatar.mimes" => "avatar category in jpeg,jpg,png,svg,webp,gif",
