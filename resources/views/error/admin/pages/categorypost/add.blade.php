                                                ...
                                                <div id="tong_quan" class="container tab-pane active wrapChangeSlug"><br>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control  @error('number_' . $langItem['value']) is-invalid @enderror" name="number_{{$langItem['value']}}" id="" rows="3"  placeholder="Nhập con số nổi bật">{{ old('number_'.$langItem['value']) }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control  @error('bonus_' . $langItem['value']) is-invalid @enderror" name="bonus_{{$langItem['value']}}" id="" rows="3"  placeholder="Nhập con số nổi bật">{{ old('bonus_'.$langItem['value']) }}</textarea>
