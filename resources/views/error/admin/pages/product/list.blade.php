                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3 mb-0" style="min-width:100px;">
                                                        <select id="" name="fill_action" class="form-control">
                                                            ...
                                                            <option value="hot"
                                                                {{ $fill_action == 'hot' ? 'selected' : '' }}>Dịch vụ hot
                                                            </option>
                                                            <option value="no_hot"
                                                                {{ $fill_action == 'no_hot' ? 'selected' : '' }}>Dịch vụ
                                                                không
                                                                hot</option>
                                                            <option value="active"
                                                                {{ $fill_action == 'active' ? 'selected' : '' }}>Dịch vụ
                                                                hiển
                                                                thị</option>
                                                            <option value="no_active"
                                                                {{ $fill_action == 'no_active' ? 'selected' : '' }}>Dịch vụ
                                                                bị
                                                                ẩn</option>
                                                        </select>
                                                    </div>
                                ...
                                <table class="table table-head-fixed" style="font-size: 13px;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="white-space-nowrap">Sản phẩm hiển thị ngoài trang chủ</th>
                                        ...
                                        @foreach ($data as $productItem)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <p class="text-primary">Không khuyến mại</p>
                                                    @endif
                                                </td>
                                                <td><input
