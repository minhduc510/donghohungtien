                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card card-outline card-primary">
                                    ...
                                    <form action="" method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 text-right">
                                                <button data-url='{{ route('admin.contact.index') }}'
                                                    class="btn btn-success search-query">Tìm
                                                    kiếm</button>
                                                <a href="{{ route('admin.contact.index') }}" class="btn btn-danger">Làm
                                                    lại</a>
                                                {{-- <form action="{{ route('admin.contact.export.excel.database') }}" method="GET">
                                                        <button type="submit" class="btn btn-success">Xuất Excel</button>
                                                    </form> --}}
                                                <button data-url='{{ route('admin.contact.export.excel.database') }}'
                            ...
                            {{-- <div class="card-header">
                                <div class="card-tools w-60" style="min-width:100px;">
                                    <form action="{{ route('admin.contact.export.excel.database') }}" method="GET">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <div class="form-group col-md-8 mb-0" style="min-width:100px;">
                                                     
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 text-right">
                                                <button type="submit" class="btn btn-primary" title="Xuất Excel"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{-- <a class="btn btn-sm btn-info" id="btn-load-transaction-detail"
                                                        data-url="{{ route('admin.contact.detail', ['id' => $contact->id]) }}"><i
                                                            class="fas fa-eye"></i></a> --}}
                                                    <a href=""
                                                        data-url="{{ route('admin.contact.destroy', ['id' => $contact->id]) }}"
                                                        class="btn btn-sm btn-info btn-danger lb_delete tooltip11"><i
