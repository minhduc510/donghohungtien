                        ...
                        <div class="card card-outline card-primary">
                            ...
                            <div class="card-body table-responsive p-3">
                                ...
                                <div class="form-group">
                                    ...
                                    is-invalid
                                    @enderror" id="" name="price_is_reduced"  value="{{ old('price_is_reduced') }}" placeholder="vnđ">
                                ...
                                <div class="form-group">
                                    ...
                                    is-invalid
                                    @enderror" id="" name="created_at"  value="{{ old('created_at') }}">
                                    @error('created_at')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    is-invalid
                                    @enderror" id="" name="end_date"  value="{{ old('end_date') }}">
                                    @error('end_date')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
