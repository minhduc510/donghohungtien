                                                ...
                                                <div id="tong_quan_{{$langItem['value']}}" class="pt-3 tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                @error('slug_'.$langItem['value']) is-invalid  @enderror" id="slug_{{ $langItem['value'] }}" value="{{ old('slug_'.$langItem['value']) }}" name="slug_{{ $langItem['value'] }}" placeholder="Gắn đường dẫn">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <textarea class="form-control tinymce_editor_init @error('description_'.$langItem['value']) is-invalid  @enderror" name="description_{{$langItem['value']}}" id="ckeditor" rows="20" value=""  placeholder="Nhập mô tả" >
                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body table-responsive p-3">
                                    <div class="wrap-load-image mb-3">
                                        <div class="form-group">
                                            <label for="">Ảnh banner slide</label>
                                    ...
                                    {{-- <div class="wrap-load-image mb-3">
                                        <div class="form-group">
                                            <label for="">Ảnh banner slide tiếng anh</label>
                                            <input type="file" class="form-control-file img-load-input border @error('image_path_en')
                                            is-invalid
                                            @enderror" id="" name="image_path_en">
                                            @error('image_path_en')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
