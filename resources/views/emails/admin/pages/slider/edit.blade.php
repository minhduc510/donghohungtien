                                            ...
                                            <div class="tab-content">
                                                @foreach ($langConfig as $langItem)
                                                    ...
                                                    @error('name_' . $langItem['value']) is-invalid @enderror"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Đường
                                                                    dẫn</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text"
                                                                        class="form-control
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control tinymce_editor_init @error('description_' . $langItem['value']) is-invalid  @enderror"
                                                                        name="description_{{ $langItem['value'] }}" id="ckeditor" rows="20" placeholder="Nhập mô tả">
                                    ...
                                    <div class="card card-outline card-primary">
                                        ...
                                        <div class="card-body table-responsive p-3">
                                            <div class="wrap-load-image mb-3">
                                                <div class="form-group">
                                                    <label for="">Ảnh banner máy tính</label>
                                                ...
                                                @if ($data->image_path)
                                                    <div class="item-avatar">
                                                        ...
                                                        <a class="btn btn-sm btn-danger deleteAvatarProductDB"
                                                            data-url="{{ route('admin.slider.delete_image_path', ['id' => $data->id]) }}">
                                            ...
                                            {{-- <div class="wrap-load-image mb-3">
                                    <div class="form-group">
                                        <label for="">Ảnh banner mobile</label>
                                        <input type="file" class="form-control-file img-load-input border" id="" value="" name="image_path_en">
                                    </div>
                                    @error('image_path_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    @if ($data->image_path_en)
                                        <div class="item-avatar">
                                            <img class="img-load border p-1 w-100" src="{{$data->image_path_en}}" alt="{{$data->name}}" style="height: 200px;object-fit:cover; max-width: 260px;">
                                            <a class="btn btn-sm btn-danger deleteAvatarProductDB"
                                               data-url="{{ route('admin.slider.delete_image_path2',['id'=>$data->id]) }}">
                                                <i class="far fa-trash-alt"></i>
                                            </a>
                                        </div>
                                    @endif
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="">Chọn kiểu</label>
                                                <select name="type" class="form-control">
                                                    @foreach (config('web_default.type_slider') as $key => $item)
