                                            ...
                                            <div class="tab-content">
                                                @foreach ($langConfig as $langItem)
                                                    <div id="tong_quan_{{ $langItem['value'] }}"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Giá
                                                                    trị</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text"
                                                                        class="form-control
                                                        @error('value_' . $langItem['value']) is-invalid  @enderror"
                                                                        id="value_{{ $langItem['value'] }}"
                                                                        value="{{ old('value_' . $langItem['value']) ?? optional($data->translationsLanguage($langItem['value'])->first())->value }}"
                                                                        name="value_{{ $langItem['value'] }}"
