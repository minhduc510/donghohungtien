                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control tinymce_editor_init @error('content_' . $langItem['value']) is-invalid  @enderror"
                                                                                name="content_{{ $langItem['value'] }}" id="" rows="20" value="" placeholder="Nhập nội dung">
                                                    ...
                                                    <div class="tab-content">
                                                        @foreach ($langConfig as $langItem)
                                                            <div id="seo_{{ $langItem['value'] }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <div class="invalid-feedback2 d-block"
                                                                            ...
                                                                            (META title <span id="da-nhap-title">70</span>
                                                                            ký tự
                                                                            và từ)
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label" for="">Nhập mô
                                                                        tả seo</label>
                                                                    <div class="">
                                                                        <input type="text"
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label" for="">Nhập từ
                                                                        khóa seo</label>
                                                                    <div class="">
                                                                        <input type="text"
...
@section('js')
    <script>
        $('.nameChangeSlug').on('keyup', function() {
            ...
            $('#keyword_seo_' + language).val(value);
        });
    </script>
