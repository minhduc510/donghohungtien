    ...
    <div class="d-flex flex-wrap ">
        <div class="box-left lb_list_content_recusive">
            <div class="d-flex">
                ...
                <div class="col-sm-3 pt-2 pb-2 parent text-center wrap-load-hot" data-url="{{ route('admin.categoryproduct.load.hot',['id'=>$childValue->id]) }}">
                    @include('admin.components.load-change-hot',['data'=>$childValue,'type'=>'sản phẩm'])
                </div>
