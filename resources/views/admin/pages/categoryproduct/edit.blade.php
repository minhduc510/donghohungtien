...
@section('content')
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="wrap-load-image mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control-file img-load-input border" id="" name="avatar_path2">
                                        </div>
                                        @error('avatar_path2')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                        @if ($data->avatar_path2)
                                        <img class="img-load border p-1 w-100" src="{{$data->avatar_path2}}" alt="{{$data->name}}" style="height: 200px;object-fit:cover; max-width: 260px;">
                                        @endif
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="form-check-label" style="padding-left: 20px; margin-top: 5px;">
                                            <input type="checkbox" class="form-check-input" value="1" name="deleteFile">
                                            Xóa file
                                        </label>
                                        @endif
                                    </div>
                                        ...
                                        <div class="card-body table-responsive">
                                                                            ...
                                                                            <div class="form-check permission-title">
                                                                                <label class="form-check-label p-3">
                                                                                    <input type="checkbox"
                                                                                        ...
                                                                                        @if ($categoryAttributeOfAdmin->contains($item->id)) {{ 'checked' }} @endif>{{ $item->name }}
                                                                                </label>
                                                                            </div>
                                                                                                ...
                                                                                                <div class="form-check">
                                                                                                    <label
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            name="category_product_attribute[]"
                                                                                                            value="{{ $itemChild->id }}"
                                                                                                            @if ($categoryAttributeOfAdmin->contains($itemChild->id)) {{ 'checked' }} @endif>{{ $itemChild->name }}
                                                                                                    </label>
                                                                                                </div>
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <label
                                                                                                                        ...
                                                                                                                        <input
                                                                                                                            ...
                                                                                                                            name="category_product_attribute[]"
                                                                                                                            value="{{ $itemChild2->id }}"
                                                                                                                            @if ($categoryAttributeOfAdmin->contains($itemChild2->id)) {{ 'checked' }} @endif>{{ $itemChild2->name }}
                                                                                                                    </label>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        @endforeach
                                                                            ...
                                                                            <div class="form-check permission-title">
                                                                                <label class="form-check-label p-3">
                                                                                    <input type="checkbox"
                                                                                        class="form-check-input check-parent"
                                                                                        value="{{ $item->id }}"
                                                                                        @if (in_array($item->id, $data->categoryFilterAttributeMenu()->pluck('attribute_id')->toArray())) checked @endif
                                                                                        name="category_filter_attribute_menu[]">{{ $item->name }}
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    @endforeach
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    value="{{ old('color') ?? $data->color }}" name="color">
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="checkbox" class="form-check-input @error('hot_2')
                            is-invalid
                        @enderror" value="1" name="hot_2" @if ((old('hot_2') ?? $data->hot_2) == '1') {{ 'checked' }} @endif>
                </label>
            </div>
            @error('hot_2')
            <div class="invalid-feedback d-block">
            ...
            @enderror
                                                ...
                                                @if ($data->avatar_path)
                                                    <div class="item-avatar">
                                                        ...
                                                        <a class="btn btn-sm btn-danger deleteAvatarProductDB"
                                                            data-url="{{ route('admin.categoryproduct.delete_avatar_path', ['id' => $data->id]) }}"><i
                                            ...
                                            {{-- <div class="wrap-load-image mb-3">
                                                ...
                                                @if ($data->icon_path)
                                                    <div class="item-icon">
                                                        <img class="img-load border p-1 w-100"
                                                            src="{{ $data->icon_path }}" alt="{{ $data->name }}"
                                                            style="height: 200px;object-fit:cover; max-width: 260px;">
                                                        <a class="btn btn-sm btn-danger deleteIconProductDB"
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            // const inputChild = document.querySelectorAll('.form-check-input.check-children');
            // console.log(inputChild)
            // inputChild.forEach(item => {
        ...
        function createSlug(name) {
            ...
            ký tự gạch ngang.replace(/ /gi, "-") //Đổi nhiều ký tự gạch ngang liên tiếp thành 1 ký tự gạch ngang //Phòng
            trường hợp người nhập vào quá nhiều ký tự trắng.replace(/\-\-\-\-\-/gi, '-').replace(/\-\-\-\-/gi, '-')
