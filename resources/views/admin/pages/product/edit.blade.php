                    ...
                    <div class="col-md-12">
                        ...
                        {{-- <div class="box-link">
                            <a href="{{ route('admin.product.tab', ['product_id' => $data->id]) }}"
                                class="btn btn-sm btn-success">Danh sách đặc điểm</a>
                        </div> --}}
                                    ...
                                    <div class="card card-outline card-primary">
                                        ...
                                        <div class="card-body table-responsive p-3">
                                            <ul class="nav nav-tabs">
                                                ...
                                                {{-- <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#hinh_anh2">Hình ảnh thưc
                                                        tế</a>
                                                </li> --}}
                                                {{-- <li class="nav-item">
                                                        ...
                                                        @foreach ($langConfig as $langItem)
                                                            <li class="nav-item">
                                                                <a class="nav-link {{ $langItem['value'] == $langDefault ? 'active' : '' }}"
                                                                    data-toggle="tab"
                                                                    href="#tong_quan_{{ $langItem['value'] }}">{{ $langItem['name'] }}
                                                                </a>
                                                            </li>
                                                        @endforeach
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" min="0"
                                                                                ...
                                                                                name="warranty"
                                                                                placeholder="Nhập Kích thước (Đồng hồ treo tường)">
                                                                            @error('warranty')
                                                                                <div class="invalid-feedback d-block">
                                                                                    {{ $message }}
                                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" min="0"
                                                                                ...
                                                                                name="color"
                                                                                placeholder="Nhập Đường kính (Đồng hồ đeo tay)">
                                                                            @error('color')
                                                                                <div class="invalid-feedback d-block">
                                                                                    {{ $message }}
                                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control tinymce_editor_init @error('model_' . $langItem['value']) is-invalid  @enderror"
                                                                                name="model_{{ $langItem['value'] }}" id="" rows="3" value=""
                                                                                placeholder="Thông số kỹ thuật">
                                                        {{ old('model_' . $langItem['value']) ?? optional($data->translationsLanguage($langItem['value'])->first())->model }}
                                                        </textarea>
                                ...
                                @endforeach --}}
                                                    <div class="form-group wrap-permission" id="loadAjaxAttribute">
                                                        <div style="border: 1px solid; padding: 5px;">
                                                            <label class="control-label" for="">Lựa chọn danh mục
                                                                được hiển thị</label>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div
                                                                            ...
                                                                            <div class="item-permission mt-2 mb-2">
                                                                                <div class="form-check permission-title">
                                                                                    <label class="form-check-label p-3">
                                                                                        <input type="checkbox"
                                                                                            class="form-check-input check-parent1 check-category"
                                                                                            value="{{ $item->id }}"
                                                                                            name="attribute[]"
                                                                                            @if ($categoryAttrOfAdmin->contains($item->id)) {{ 'checked' }} @endif>{{ $item->name }}
                                                                                    </label>
                                                                                </div>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <label
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                name="attribute[]"
                                                                                                                value="{{ $itemChild->id }}"
                                                                                                                @if ($categoryAttrOfAdmin->contains($itemChild->id)) {{ 'checked' }} @endif>{{ $itemChild->name }}
                                                                                                        </label>
                                                                                                    </div>
                                                            ...
                                                            @foreach ($data->images()->get() as $productImageItem)
                                                                ...
                                                                <li style="position: relative">
                                                                    <a href="javascript:void(0);"
                                                                        style="background-image: url({{ asset($productImageItem->image_path) }});"></a>
                                                ...
                                                <div id="hinh_anh2" class="container tab-pane fade">
                                                    ...
                                                    <div class="wrap-load-image mb-3">
                                                        <style>
                                                            ...
                                                            .image-list-small2 .details h3 a {
                                                                color: #303030;
                                                                text-decoration: none;
                                                            }

                                                            .image-list-small2 .details .image-author {
                                                                display: block;
                                                                color: #717171;
                                                                font-size: 11px;
                                                                font-weight: normal;
                                                        ...
                                                        <hr>
                                                        <span class="badge badge-primary mb-3">Thêm ảnh thực tế</span>
                                                        <div class="form-group">
                                                            <input type="file"
                                                                class="form-control-file img-load-input-multiple border"
                                                        ...
                                                        @error('image2')
                                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                                        @enderror
                                                        <ul class="image-list-small2">
                                                            @foreach ($data->images2()->get() as $productImageItem)
                                                                @php
                                                                    $url = asset('');
                                                                @endphp
                                                                ...
                                                                <li style="position: relative">
                                                                    ...
                                                                    <input type="hidden" name="file_xx2[]"
                                                                        value="{{ $productImageItem->image_path }}">
                                                                    <a style="position:absolute; top:0; right:0; width:25px; height:27px;"
                                                                        class="btn btn-sm btn-danger lb_delete_image_new2"
                                                                        data-id="{{ $productImageItem->id }}"
                                                                        data-url="{{ route('admin.product.destroy-image', ['id' => $productImageItem->id]) }}"><i
                                                                            class="far fa-trash-alt"></i></a>
                                                                </li>
                                                ...
                                                @if ($data->avatar_path2)
                                                    <div class="item-avatar">
                                                        <img class="img-load border p-1 w-100" id="img_avatar_path"
                                                            ...
                                                            style="height: 200px;object-fit:cover; max-width: 260px;">
                                                        <a class="btn btn-sm btn-danger deleteAvatarProductDB"
                                                            data-url="{{ route('admin.product.delete_avatar_path2', ['id' => $data->id]) }}"><i
                                                                class="far fa-trash-alt"></i>
                                                        </a>
                                                    </div>
                                                @endif
...
@enderror
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input id="old_price_hide" type="hidden" min="0"
                                                            class="form-control  @error('old_price') is-invalid  @enderror"
                                                            value="{{ old('old_price') ?? $data->old_price }}"
                                                            name="old_price" placeholder="Nhập Giảm giá(%)">
                                                        @error('old_price')
                                                            <div class="invalid-feedback d-block">
                                                                {{ $message }}
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-7">
                                                                    <label class="control-label" for="">Sản phẩm
                                                                        khuyến
                                                                        mãi
                                                                    </label>
                                                                </div>
                                                                        ...
                                                                        <label class="form-check-label">
                                                                            <input type="checkbox"
                                                                                class="form-check-input @error('sale')
                                                                                    ...
                                                                                    @enderror"
                                                                                value="1" name="sale"
                                                                                @if ((old('sale') ?? $data->sale) == '1') {{ 'checked' }} @endif>
                                                                        </label>
                                                                    </div>
                                                                    @error('sale')
                                                                        <div class="invalid-feedback d-block">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label" for="">Hiển thị
                                                                        trang
                                                                        chủ</label>
                                                                </div>
                                                                <div class="col-md-5">
                                    ...
                                    @enderror"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label class="control-label" for="">Còn
                                                                        hàng</label>
                                                                </div>
                                                                <div class="col-md-5">
                                                                    <div class="form-check-inline">
                                    ...
                                    @enderror"
                                                                                value="1" name="size"
                                                                                @if ((old('size') ?? $data->size) == '1') {{ 'checked' }} @endif>
                                                                        </label>
                                                                    </div>
                                                                    @error('size')
                                                                        <div class="invalid-feedback d-block">
    ...
    @enderror
                                            ...
                                            <div class="item-price-default">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" min="0"
                                                        ...
                                                        value="{{ old('size') ?? $data->size }}" name="size"
                                                ...
                                                @foreach ($data->options()->latest()->get() as $key => $item)
                                                    <div class="item-price">
                                                        <div class="box-content-price">
                                                            <div class="form-group">
                                                                <label class="control-label" for="">Màu
                                                                    sắc</label>
                                                                <input type="text" min="0"
                                                                    class="form-control  @error('colorOptionOld.' . $key) is-invalid  @enderror"
                                                                    value="{{ old('colorOptionOld')[$key] ?? $item->color }}"
                                                                    name="colorOptionOld[]" placeholder="Nhập Màu sắc">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label" for="">Kích
                                                                    thước</label>
                                                                <input type="text" min="0"
                                                                    class="form-control  @error('sizeOptionOld.' . $key) is-invalid  @enderror"
                                                                    value="{{ old('sizeOptionOld')[$key] ?? $item->size }}"
                                                                    name="sizeOptionOld[]"
                                                                    placeholder="Nhập đơn vị Kích thước">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label" for="">Thể
                                                                    tích</label>
                                                                <input type="text" min="0"
                                                                    class="form-control  @error('volumeOptionOld.' . $key) is-invalid  @enderror"
                                                                    value="{{ old('volumeOptionOld')[$key] ?? $item->volume }}"
                                                                    name="volumeOptionOld[]"
                                                                    placeholder="Nhập đơn vị thể tích">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="idOption[]"
                                                                    value="{{ $item->id }}">
                                                                <input type="number" min="0"
                                                                    class="form-control  @error('priceOptionOld.' . $key) is-invalid  @enderror"
                                                                    value="{{ old('priceOptionOld')[$key] ?? $item->price }}"
                                                                    name="priceOptionOld[]" placeholder="Nhập giá">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label" for="">Giá cũ</label>
                                                                <input type="number" min="0"
                                                                    class="form-control  @error('old_priceOptionOld.' . $key) is-invalid  @enderror"
                                                                    value="{{ old('old_priceOptionOld')[$key] ?? $item->old_price }}"
                                                                    name="old_priceOptionOld[]" placeholder="Nhập giá cũ">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                is-invalid @enderror"
                                                                    id="" name="avatar_typeOld[]">
                                                                @if ($item->avatar_type)
                                                                    <img src="{{ asset($item->avatar_type) }}"
                                                                        alt="{{ $item->name }}">
                                                                @endif
                                                        ...
                                                        <div class="action">
                                                            <a class="btn btn-sm btn-danger deleteOptionProductDB"
                                                                data-url="{{ route('admin.product.destroyOptionProduct', ['id' => $item->id]) }}"><i
                                                                    class="far fa-trash-alt"></i></a>
                                                        </div>
                                                    </div>
                                                @endforeach
            ...
            @enderror
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label" for="">Đơn vị
                                                                        khối
                                                                        lượng</label>
                                                                    <input type="text" min="0"
                                                                        class="form-control  @error('size') is-invalid  @enderror"
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label" for="">Giá
                                                                        mới</label>
                                                                    <input type="number" min="0"
...
@section('js')
    <script>
        $(function() {
            ...
            //     console.log(098)
            //     $(this).parents('.item-permission').find('.check-children').prop('checked', $(this).prop(
            //         'checked'));
            // });
            console.log(document.querySelectorAll('.check-parent'))
            document.querySelectorAll('.check-parent').forEach((e) => e.addEventListener('change', function() {
                console.log(123)
                $(this).parents('.item-permission').find('.check-children').prop('checked', $(this)
                    .prop(
                        'checked'));
            }));
    ...
    <script>
        $(function() {
            ...
            // $('.slug-test').val($('input[name="slug"]').val())
        });
    ...
    <script>
        $(function() {
            ...
            $(".image-list-small2").sortable({
                change: function(event, ui) {
                    var form = $("#formNew");
                    form.find("input[name='index2[]']").remove();

                    $(".image-list-small2 li").each(function(index, element) {
                        var inputValue = $(element).find("input[name='file_xx2[]']").val();
                        if (inputValue && inputValue.trim() !== "") {
                            form.append('<input type="hidden" name="index2[]" value="' +
                                inputValue + '">');
                        }
                    });
                },
    ...
    <script>
        ...
        $(document).on('change', 'input[name="image2[]"]', function(e) {
            // var count = $(this).val();
            // console.log(count.length);
            var file = e.target.files;
            var product_id_hidden = $('input[name="product_id_hidden"]').val();
            var formData = new FormData();
            for (let i = 0; i < file.length; i++) {
                formData.append('image2' + i, file[i]);
            }
            formData.append('id', product_id_hidden);
            formData.append("total", file.length);
            $.ajax({
                ...
                url: "{{ route('admin.product.uploadFileNew2') }}",
                cache: false,
                type: "POST",
                data: formData,
                processData: false, ///required to upload file
                ...
                success: function(response) {
                    ...
                    <li style="position: relative">
                        <a href="javascript:;" style="background-image: url(${assetUrl}storage/${u[j]});"></a>
                        <input type="hidden" name="file_xx2[]" value="storage/` + u[j] + `">
                    </li>
                    `;
                    }
                    $('.image-list-small2').append(html);
                },
            });
        });
        ...
        $(".lb_delete_image_new2").click(function() {
            // Xóa phần tử li chứa nút đã được click
            var dataId = $(this).data('id');
            var hiddenInput = '<input type="hidden" name="deleted_image_ids2[]" value="' + dataId + '">';
            $("form").append(hiddenInput);
            $(this).closest("li").remove();
        });
    </script>
