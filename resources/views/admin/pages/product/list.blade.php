                                                    ...
                                                    <div class="form-group col-md-3 mb-0" style="min-width:100px;">
                                                        <select id="" name="fill_action" class="form-control">
                                                            ...
                                                            <option value="no_active"
                                                                ...
                                                                ẩn</option>
                                                            <option value="sale"
                                                                {{ $fill_action == 'sale' ? 'selected' : '' }}>Sản
                                                                phẩm
                                                                khuyến mãi</option>
                                                            <option value="no_sale"
                                                                {{ $fill_action == 'no_sale' ? 'selected' : '' }}>Sản
                                                                phẩm không
                                                                khuyến mãi</option>
                                                        </select>
                                                    </div>
                                ...
                                <table class="table table-head-fixed" style="font-size: 13px;">
                                    ...
                                    <tbody>
                                        @foreach ($data as $productItem)
                                            ...
                                            @if (isset($idCategorySearch) && count($idCategorySearch) > 0)
                                                @if (in_array($productItem->category_id, $idCategorySearch))
                                                    <tr>
                                                        <td>
                                                            <input class="delete_checkbox" type="checkbox"
                                                                name="deleteCheckbox" value="{{ $productItem->id }}">
                                                        </td>
                                                        ...
                                                        <td class="wrap-load-hot"
                                                            ...
                                                            @include(
                                                                'admin.components.load-change-promotional',
                                                                [
                                                                    'data' => $productItem,
