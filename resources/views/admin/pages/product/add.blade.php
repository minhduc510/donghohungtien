                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-2">
                                                                            <label class="control-label" for="">Kích
                                                                                thước (Đồng hồ treo tường)</label>
                                                                        </div>
                                                                        <div class="col-md-10">
                                                                            <input type="text" min="0"
                                                                                ...
                                                                                value="{{ old('warranty') }}"
                                                                                name="warranty"
                                                                                placeholder="Kích thước (Đồng hồ treo tường)">
                                                                            @error('warranty')
                                                                                <div class="invalid-feedback d-block">
                                                                                    {{ $message }}
                                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" min="0"
                                                                                ...
                                                                                value="{{ old('color') }}"
                                                                                name="color"
                                                                                placeholder="Đường kính (Đồng hồ đeo tay)">
                                                                            @error('color')
                                                                                <div class="invalid-feedback d-block">
                                                                                    {{ $message }}
                                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control tinymce_editor_init @error('description_' . $langItem['value']) is-invalid  @enderror"
                                                                                name="description_{{ $langItem['value'] }}" id="ckeditor" rows="3" value=""
