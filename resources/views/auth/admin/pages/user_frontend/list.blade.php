                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      @endif
                                        ...
                                        <a data-url="{{route('admin.user_frontend.destroy',['id'=>$item->id])}}" class="btn btn-sm btn-danger lb_delete tooltip"><i class="far fa-trash-alt"></i><span class="tooltiptext">Xóa</span></a> 
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
