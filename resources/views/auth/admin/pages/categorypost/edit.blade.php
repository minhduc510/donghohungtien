                                                    ...
                                                    <div class="tab-content">
                                                            ...
                                                            <div id="tong_quan_{{ $langItem['value'] }}"
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text"
                                                                                class="form-control resultSlug resultSlug_{{ $langItem['value'] }} resultSlug1_{{ $langItem['value'] }} changeAlias1 {{ $langItem['value'] }}
                                                                ...
                                                                {{-- <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Nhập con số nổi bật</label>
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control  @error('number_' . $langItem['value']) is-invalid @enderror" name="number_{{$langItem['value']}}" id="" rows="3"  placeholder="Nhập con số nổi bật">{{ old('number_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->number  }}</textarea>
                                                                    @error('number_' . $langItem['value'])
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control  @error('bonus_' . $langItem['value']) is-invalid @enderror" name="bonus_{{$langItem['value']}}" id="" rows="3"  placeholder="Nhập con số nổi bật">{{ old('bonus_'.$langItem['value'])??optional($data->translationsLanguage($langItem['value'])->first())->bonus  }}</textarea>
                                                                    @error('bonus_' . $langItem['value'])
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                        <div class="next-input--stylized">
                                                                                            ...
                                                                                            <input type="text"
                                                                                                class="next-input next-input--invisible resultSlug resultSlug2_{{ $langItem['value'] }} changeAlias2 {{ $langItem['value'] }}
                                                                                    @error('slug_' . $langItem['value']) is-invalid  @enderror"
                                                                                                id="slug_{{ $langItem['value'] }}"
                                                                                                data-lg="{{ $langItem['value'] }}"
                                                                                                value="{{ old('slug_' . $langItem['value']) ?? optional($data->translationsLanguage($langItem['value'])->first())->slug }}"
                                    ...
                                    <div class="card card-outline card-primary">
                                        ...
                                        <div class="card-body table-responsive">
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                <input type="color"class="form-control  @error('color') is-invalid  @enderror"  value="{{ old('color')??$data->color }}" name="color">
                                                ...
                                                @if ($data->avatar_path)
                                                    <div class="item-avatar">
                                                        ...
                                                        <a class="btn btn-sm btn-danger deleteAvatarProductDB"
                                                            data-url="{{ route('admin.categorypost.delete_avatar_path', ['id' => $data->id]) }}">
                                                ...
                                                @if ($data->icon_path)
                                                    <div class="item-avatar">
                                                        <img class="img-load border p-1 w-100"
                                                            ...
                                                            style="height: 200px;object-fit:cover; max-width: 260px;">
                                                        <a class="btn btn-sm btn-danger deleteAvatarProductDB"
                                                            data-url="{{ route('admin.categorypost.delete_icon_path', ['id' => $data->id]) }}">
                                                            <i class="far fa-trash-alt"></i>
                                                        </a>
                                                    </div>
                                                @endif
