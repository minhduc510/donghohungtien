        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="d-flex justify-content-between ">
                    <a href="{{route('admin.galaxy.create1')}}" class="btn  btn-info btn-md mb-2">+ Thêm mới</a>
                </div>

                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <div class="card-tools w-100 mb-3">
                            <form action="{{ route('admin.galaxy.video') }}" method="GET">
                                <div class="row">
                                    <div class="col-md-10">
                                        <div class="row">
                                    ...
                                    <div class="col-md-1 mb-0">
                                        <a  class="btn btn-danger w-100" href="{{ route('admin.galaxy.video') }}">Làm lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <thead>
                                <tr>
                                    <tr>
                                        ...
                                        <th class="white-space-nowrap">Video</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="white-space-nowrap">
                                        ...
                                        <a href="{{route('admin.galaxy.edit1',['id'=>$reviewItem->id])}}" class="btn btn-sm btn-info tooltip11"><i class="fas fa-edit"></i><span class="tooltiptext">Sửa</span></a>
