                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <textarea class="form-control tinymce_editor_init @error('description_' . $langItem['value']) is-invalid  @enderror"
                                                                        name="description_{{ $langItem['value'] }}" id="ckeditor" rows="20" value=""
                                        ...
                                        <div class="card-body table-responsive p-3">
                                                ...
                                                @if ($data->image_path)
                                                    <div class="item-avatar">
                                                        ...
                                                        <a class="btn btn-sm btn-danger deleteAvatarProductDB"
                                                            data-url="{{ route('admin.setting.delete_image_path', ['id' => $data->id]) }}">
                                            ...
                                            {{-- <div class="wrap-load-image mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control-file img-load-input border" id="" value="" name="image_path2">
                                                </div>
                                                @error('image_path2')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                                @enderror
                                                @if ($data->image_path2)
                                                <img class="img-load border p-1 w-100" src="{{asset($data->image_path2)}}" alt="{{$data->name}}" style="object-fit:contain;">
                                                @endif
                                            </div> --}}
                                                ...
                                                @if ($data->icon_path)
                                                    <div class="item-avatar">
                                                        <img class="img-load border p-1 w-100"
                                                            ...
                                                            style="height: 200px;object-fit:cover; max-width: 260px;">
                                                        <a class="btn btn-sm btn-danger deleteAvatarProductDB"
                                                            data-url="{{ route('admin.setting.delete_icon_path', ['id' => $data->id]) }}">
                                                            <i class="far fa-trash-alt"></i>
                                                        </a>
                                                    </div>
                                                @endif
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="">Mã màu background</label>
