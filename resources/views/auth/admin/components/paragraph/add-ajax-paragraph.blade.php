<form class="form-horizontal formEditParagaphAjax" data-url="{{ $urlStore }}" method="POST"
                ...
                @foreach ($langConfig as $langItem)
                    <li class="nav-item">
                        <a class="nav-link {{ $langItem['value'] == $langDefault ? 'active' : '' }}" data-toggle="tab"
                            href="#tt_paragraph_add_{{ $langItem['value'] }}">{{ $langItem['name'] }}</a>
                    </li>
                @endforeach
            </ul>
            <div class="tab-content">
                @foreach ($langConfig as $langItem)
                    <div id="tt_paragraph_add_{{ $langItem['value'] }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value=""
                                        name="nameParagraphAdd_{{ $langItem['value'] }}" placeholder="Nhập tên"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <textarea
                                        class="form-control tinymce_editor_init @error('valueParagraphAdd_' . $langItem['value']) is-invalid  @enderror"
                                        name="valueParagraphAdd_{{ $langItem['value'] }}" id="valueParagraphAdd_{{ $langItem['value'] }}" rows="15" value=""
        ...
        <div class="col-md-3">
            <div class="wrap-load-image mb-3">
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file img-load-input border" id=""
                        name="image_path_paragraph_add">
                </div>
                <img class="img-load border p-1 w-100" src="{{ asset('admin_asset/images/upload-image.png') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" id="paragraphType" data-url="{{ $routeLoadParagraphType }}"
                            value="" name="typeParagraphAdd" required>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" id="paragraphParent" value="" name="parentIdParagraphAdd"
                            required>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" min="0" class="form-control" value=""
                            name="orderParagraphAdd" placeholder="Nhập số thứ tự">
                    </div>
                </div>
            </div>
            <div class="form-group">
