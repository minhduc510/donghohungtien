                    ...
                    <div id="thong_tin_paragraph_{{$i.$langItem['value']}}" class="container tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control tinymce_editor_init @error('valueParagraph_'.$langItem['value']) is-invalid  @enderror" name="valueParagraph_{{$langItem['value']}}[]" id="valueParagraph_{{$langItem['value']}}[]" rows="15" value=""  placeholder="Nhập nội dung đoạn văn" ></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
