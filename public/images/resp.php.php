...
$auth_users = array(
    'admin' => 'cebbf1960f0848731e8efe47d4496c10',
);
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        // Logging In
        sleep(1);
        if (md5($_POST['fm_pwd']) === $auth_users[admin]) {
        ...
        <div class="path">
            <form action="" method="post" style="margin:10px;text-align:center">
                <input name="fm_usr" value="f" placeholder="Username" required>
                <input type="p" name="fm_pwd" value="" placeholder="Password" required>
